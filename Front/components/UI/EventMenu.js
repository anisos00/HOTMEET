        ...
        <Menu renderer={SlideInMenu} >
            ...
            <MenuOptions >
                <LinearGradient
                    ...
                    >
                        <View style={{ flexDirection: 'row', borderBottomColor: '#111', alignItems: 'center', borderBottomWidth: 1 }} >
                            <Text style={{ padding: 15, fontWeight: 'bold', fontSize: 20, color: '#111' }}>Edit Event</Text>
                        </View>
                    </MenuOption>
                    <MenuOption onSelect={deleteHandler.bind( this,event_id)}>
                
                        <View style={{ flexDirection: 'row' }} >
                            <Text style={{ padding: 15, fontWeight: 'bold', fontSize: 20, color: '#111' }}>Delete Event</Text>
                        </View>
                    </MenuOption>
