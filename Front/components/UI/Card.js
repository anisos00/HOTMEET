    ...
    return (
        <TouchableComp 
            ...
            onPress={() =>  
                ...
                {} 
                : 
                navigation.navigate('UserProfile', { userId: post.postedBy._id, name: post.postedBy.username }) }
        >
            <View style={styles.card}>
                    ...
                    <View style={{ display: 'flex', flex: 1, flexDirection: 'row' }} >
                        <View style={styles.timeContainer}>
                            ...
                            <Text 
                                ...
                                onPress={() => navigation.navigate('UserProfile', { userId: post.postedBy._id, name: post.postedBy.username })} 
                            > 
                ...
                <View style={styles.cardImageContainer} >
                    <Image 
                        style={{...styles.cardImage, height: 300, width: '100%' }}
