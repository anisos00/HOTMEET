...
exports.userById = (req, res, next, id) => {
    ...
    .select('username email phoneNumber created about ')
    .exec((err, user) => {
        if(err || !user){
...
exports.allUsers = (req,res) => {
    ...
    .select("username email phoneNumber updated created about notificationToken")
...
exports.editUser = (req, res, next) => {
    ...
    user.updated = Date.now();
     ...
     const allowedFields = { email: req.body.email, phoneNumber: req.body.phoneNumber,username: req.body.username, password: req.body.password };
